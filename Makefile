...
install :; forge install cyfrin/foundry-devops@0.3.2 --no-commit && forge install smartcontractkit/chainlink-brownie-contracts@1.3.0 --no-commit && forge install foundry-rs/forge-std@v1.9.6 --no-commit
